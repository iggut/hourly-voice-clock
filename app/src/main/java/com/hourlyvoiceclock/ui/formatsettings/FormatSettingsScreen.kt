            ...
            Column(
                ...
                Card(
                    ...
                    Column(modifier = Modifier.padding(18.dp)) {
                        ...
                        Row(
                            ...
                            modifier = Modifier.fillMaxWidth().clip(RoundedCornerShape(8.dp)).selectable(
                ...
                Card(
                    ...
                    Column(modifier = Modifier.padding(18.dp)) {
                        ...
                        PhraseStyle.values().forEach { style ->
                            Row(
                                verticalAlignment = Alignment.CenterVertically,
                                modifier = Modifier.fillMaxWidth().clip(optionShape).selectable(
                ...
                Card(
                    ...
                    Column(modifier = Modifier.padding(18.dp), verticalArrangement = Arrangement.spacedBy(12.dp)) {
                        ...
                        Row(
                            modifier = Modifier.fillMaxWidth().clip(RoundedCornerShape(8.dp)).toggleable(
                                value = vibrateBefore,
                                onValueChange = { viewModel.setVibrateBefore(it) },
                                role = Role.Switch
                            ),
                            horizontalArrangement = Arrangement.SpaceBetween,
                            verticalAlignment = Alignment.CenterVertically
                        ...
                        Row(
                            modifier = Modifier.fillMaxWidth().clip(RoundedCornerShape(8.dp)).toggleable(
                                value = announceDate,
                                onValueChange = { viewModel.setAnnounceDate(it) },
                                role = Role.Switch
                            ),
                            horizontalArrangement = Arrangement.SpaceBetween,
                            verticalAlignment = Alignment.CenterVertically
